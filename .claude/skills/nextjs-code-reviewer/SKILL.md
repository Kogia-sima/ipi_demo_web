...
description: Invoke when quality-reviewer reviews Next.js App Router code. Provides framework-specific review checklist covering file organization, server/client component usage, data fetching correctness, metadata configuration, and performance patterns.
---
