...
const SCENARIO_1: Scenario = {
  ...
  events: [
    ...
    { at: 32200, kind: "attack-off" },
    { at: 32500, kind: "complete" },
  ],
};
...
const SCENARIO_2: Scenario = {
  ...
  events: [
    ...
    { at: 32700, kind: "attack-off" },
    { at: 33000, kind: "complete" },
  ],
};
...
const SCENARIO_3: Scenario = {
  ...
  events: [
    ...
    { at: 34200, kind: "attack-off" },
    { at: 34500, kind: "complete" },
  ],
};
